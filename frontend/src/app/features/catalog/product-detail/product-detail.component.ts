      ...
      <div class="product-stage">
        ...
        <section class="stage-visual reveal">
          <div class="media-main">
            <img [src]="mainImage" [alt]="product.name" class="media-content"
          ...
          @if (product.imagePaths && product.imagePaths.length > 1) {
            <div class="media-thumbnails">
              @for (img of product.imagePaths; track img; let i = $index) {
                <button class="thumb-btn" [class.active]="i === selectedImageIndex" (click)="selectedImageIndex = i">
...
export class ProductDetailComponent implements OnInit, AfterViewInit {
  ...
  get mainImage(): string {
    if (this.product?.imagePaths && this.product.imagePaths.length > 0) {
      return this.product.imagePaths[this.selectedImageIndex];
    }
    return this.product?.imageUrl || 'https://placehold.co/600x500/1a1a2e/7C6FF7?text=E-Store';
  }
